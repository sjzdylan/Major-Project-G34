...
<div class="mySlides fade">
  ...
  <img src="images/strongpwchi.jpg" style="width:100%; border: solid;">
  <div class="text">skidiki</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 2</div>
  <img src="images/phishchi.jpg" style="width:100%; border: solid;">
    ...
    if($fetchdata > 0)
        {
            ...
            foreach($fetchdata as $key => $row)
            {
                    ...
                    ?>      
                        ...
                        <a style="text-decoration: none;" href="cart.php?id=<?=$key; ?>" class="loginbutton" name="addtocart" type="submit">加入购物车</a>
                        </form>
                        </div>
                        </div>
